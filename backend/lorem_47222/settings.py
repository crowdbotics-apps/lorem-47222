"""
Django settings for lorem_47222 project.
...
WSGI_APPLICATION = 'lorem_47222.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lorem_47222 API",
    "DESCRIPTION": "API documentation for lorem_47222 App",
    "VERSION": "v1",
}
